# 🧠 NPG Studio | AI Focus Dashboard

> **Built by Team Neural Nexora**  
...
Developed by **Team Neural Nexora**, it combines **IoT hardware + signal processing + deep learning** into a single interactive dashboard.

---

## 🌟 Overview

NPG Studio transforms raw brain signals into actionable insights:
...
-  Before 1 min → -- After → AI prediction starts
...
🚦 Workflow
1. Pair Device → Click PAIR DEVICE
2. Start Session → Begin streaming
3. Calibration (0–60 sec) → Focus = --
4. AI Prediction → Live focus %
...
👥 Team Neural Nexora
1. Lavina Korani – Team Lead, BCI Research
2. Mann Chavda – IoT LEARNER
3. Nisarg Pandya – DSA Expert
4. Aman Yadav – Cloud (AWS)
5. Tasneem Kolsawala – MERN Developer
6. Tanishka Trivedi – MERN Developer
